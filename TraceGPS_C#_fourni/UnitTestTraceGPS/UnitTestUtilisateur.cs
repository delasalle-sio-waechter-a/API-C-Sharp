...
namespace UnitTestTraceGPS
{
    ...
    public class UnitTestUtilisateur
    {
        ...
        public void getIdTest()
        {
            ...
            Assert.AreEqual(0, utilisateur1.getId(), 0.0001);
            Assert.AreEqual(111, utilisateur2.getId(), 0.0001);
        ...
        public void setPseudoTest()
        {
            ...
            utilisateur1.setPseudo("test");
            Assert.AreEqual("test", utilisateur1.getPseudo());
        ...
        public void setMdpSha1Test()
        {
            ...
            utilisateur1.setMdpSha1("testmdp");
            Assert.AreEqual("testmdp", utilisateur1.getMdpSha1());
        ...
        public void setAdrMailTest()
        {
            ...
            utilisateur1.setAdrMail("test@free.com");
            Assert.AreEqual("test@free.com", utilisateur1.getAdrMail());
        ...
        public void setNumTelTest()
        {
            ...
            utilisateur1.setNumTel("0000000000");
            Assert.AreEqual("00.00.00.00.00", utilisateur1.getNumTel());
        ...
        {
            utilisateur1.setNiveau(10);
            Assert.AreEqual(10, utilisateur1.getNiveau());
        }
        ...
        {
            utilisateur1.setDateCreation(Convert.ToDateTime("01/01/0001 00:00:00"));
            Assert.AreEqual(Convert.ToDateTime("01/01/0001 00:00:00"), utilisateur1.getDateCreation());
        }
        ...
        public void setNbTracesTest()
        {
            ...
            Assert.AreEqual(10, utilisateur1.getNbTraces());
        }
        ...
        {
            utilisateur1.setDateDerniereTrace(Convert.ToDateTime("10/10/1000 00:00:00"));
            Assert.AreEqual(Convert.ToDateTime("10/10/1000 00:00:00"), utilisateur1.getDateDerniereTrace());
        }
